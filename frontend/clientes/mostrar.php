...
<html lang="es">
	<head>
		...
		<!-- Title -->
		<title>Clientes | Hotel "MI CIELO"</title>
					...
					<div class="row gutters">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							<div class="table-container">
								<div class="t-header">Clientes</div>
...
$sentencia = $connect->prepare("SELECT * FROM clientes ORDER BY iddn DESC;");
 $sentencia->execute();
$data =  array();
if($sentencia){
  while($r = $sentencia->fetchObject()){
    $data[] = $r;
									...
									<table id="basicExample" class="table custom-table">
										...
										<tbody>
											...
											<tr>
												<td><?php echo $d->dnic ?></td>
												<td><?php echo $d->numc ?></td>
												<td><?php echo $d->nomc ?></td>
												<td><?php echo $d->apec ?></td>
												<td><?php 
          if ($d->estac==1) {
	...
	<div class="btn-group">
												...
												<div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 38px, 0px);">
													<a class="dropdown-item" href="../clientes/editar.php?id=<?php echo $d->iddn ?>">Editar</a>
													<a class="dropdown-item" href="../clientes/eliminar.php?id=<?php echo $d->iddn ?>">Eliminar</a>
