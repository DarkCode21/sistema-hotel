									...
									<div class="row gutters">
										<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
											<div class="form-group">
												...
												<input type="hidden" name="rxentr" value="<?php echo $d->feentra; ?>">
												<input type="hidden" name="rxsali" value="<?php echo $d->fesal; ?>">
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="text"  value="<?php echo $d->adel; ?>" readonly class="form-control" name="rxade">
											</div>
