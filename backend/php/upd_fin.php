...
if(isset($_POST['upd_fin']))
{
    ...
    $sal=$_POST['rxsali'];
         ...
         $statement3 = $connect->prepare("INSERT INTO rs_history (idhab,idrese,iddn,nomc,numiha,detaha,precha,ent,sal) VALUES('$idhab','$idrese','$iddn','$nomc','$numiha','$detaha','$precha','$ent','$sal')");
