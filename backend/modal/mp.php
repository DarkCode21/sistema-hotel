					...
					<form class="row gutters" method="POST">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text"  class="form-control" autocomplete="off" name="mdnom" placeholder="Nombre del cliente">
							</div>
						</div>
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
							<div class="form-group">
								...
								<input type="text"  class="form-control" autocomplete="off" name="mdap" placeholder="Apellido del cliente">
							</div>
						</div>
